...
1. In the pop up window to create an environment, Click on **Create**. This will create a new power platform developer environment. On the **Create a table** page, select **Cancel**.
